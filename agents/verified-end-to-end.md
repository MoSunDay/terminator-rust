...
All suites green (ui-style, mouse-key, windows W1-W10, ipc-oc, cjk,
oc-exit, migrate M1-M5, remote); Xvfb scripts export TERMINATOR_OPAQUE=1;
live-verified
...
- windows/lifecycle: Ctrl+Shift+N second OS window, last-pane close
  ...
  quits from any window, WM close honored; borderless chrome-drag window move = live-desktop check
